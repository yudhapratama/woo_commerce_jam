...
$menu[2] = array( __('Dashboard'), 'read', 'index.html', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard' );

$submenu[ 'index.html' ][0] = array( __('Home'), 'read', 'index.html' );

if ( is_multisite() ) {
	$submenu[ 'index.html' ][5] = array( __('My Sites'), 'read', 'my-sites.php' );
}
...
if ( ! is_multisite() ) {
	...
	elseif ( current_user_can( 'update_plugins' ) )
		...
		$cap = 'update_themes';
	$submenu[ 'index.html' ][10] = array( sprintf( __('Updates %s'), "<span class='update-plugins count-{$update_data['counts']['total']}' title='{$update_data['title']}'><span class='update-count'>" . number_format_i18n($update_data['counts']['total']) . "</span></span>" ), $cap, 'update-core.php');
	unset( $cap );
}
