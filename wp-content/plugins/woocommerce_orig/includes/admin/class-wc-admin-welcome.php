...
class WC_Admin_Welcome {
	...
	public function admin_head() {
		remove_submenu_page( 'index.html', 'wc-about' );
		remove_submenu_page( 'index.html', 'wc-credits' );
		remove_submenu_page( 'index.html', 'wc-translators' );
	...
	private function intro() {
		...
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab <?php if ( $_GET['page'] == 'wc-about' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'wc-about' ), 'index.html' ) ) ); ?>">
				<?php _e( "What's New", 'woocommerce' ); ?>
			</a><a class="nav-tab <?php if ( $_GET['page'] == 'wc-credits' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'wc-credits' ), 'index.html' ) ) ); ?>">
				<?php _e( 'Credits', 'woocommerce' ); ?>
			</a><a class="nav-tab <?php if ( $_GET['page'] == 'wc-translators' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'wc-translators' ), 'index.html' ) ) ); ?>">
	...
	public function welcome() {
		...
		wp_redirect( admin_url( 'index.html?page=wc-about' ) );
		exit;
	}
}
