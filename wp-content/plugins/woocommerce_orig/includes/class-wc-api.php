...
class WC_API {
	...
	public function add_endpoint() {
		...
		// REST API
		add_rewrite_rule( '^wc-api/v([1-2]{1})/?$', 'index.html?wc-api-version=$matches[1]&wc-api-route=/', 'top' );
		add_rewrite_rule( '^wc-api/v([1-2]{1})(.*)?', 'index.html?wc-api-version=$matches[1]&wc-api-route=$matches[2]', 'top' );
