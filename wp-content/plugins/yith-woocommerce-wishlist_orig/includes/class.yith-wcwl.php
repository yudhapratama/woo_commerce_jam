...
if ( ! class_exists( 'YITH_WCWL' ) ) {
    ...
    class YITH_WCWL {
        ...
        public function add_rewrite_rules() {
            ...
            add_rewrite_rule( '^' . $wishlist_page_slug . '(/(.*))?/page/([0-9]{1,})/?$', 'index.html?pagename=' . $wishlist_page_slug . '&wishlist-action=$matches[2]&paged=$matches[3]', 'top' );
            add_rewrite_rule( '^' . $wishlist_page_slug . '(/(.*))?/?$', 'index.html?pagename=' . $wishlist_page_slug . '&wishlist-action=$matches[2]', 'top' );
